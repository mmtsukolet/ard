...
<script>
	...
	app.controller('usersCtrl', function($scope, $http) {
		...
		$http.get("http://localhost/lumen/public/read-users")
		...
		$scope.save = function(modalstate,user_id){
			switch(modalstate){
				case 'add': var url = "http://localhost/lumen/public/create-user"; break;
				case 'edit': var url = "http://localhost/lumen/public/edit-user/"+user_id; break;
				default: break;
			}
			$http({
				method  : 'POST',
		...
		$scope.confirmDelete = function(id) {
			...
			if(isOkDelete) { 
				$http.post('http://localhost/lumen/public/delete-user', {id:id}).
